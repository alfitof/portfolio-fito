      ...
      >
        ...
        >
          <p
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            I am available for full-time roles, freelance engagements, and
            selective project collaborations. If you have something meaningful
            in mind, I'd love to hear about it — I typically respond within 24
            hours.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <a
                href="mailto:alfito.fbriansyah@gmail.com"
          ...
          {status === "success" ? (
            <div className="h-full min-h-[200px] flex flex-col items-center justify-center text-center gap-3">
              ...
              <button
                ...
                className="text-[10px] uppercase tracking-widest mt-1 transition-colors hover:opacity-80"
                style={{ color: "var(--text-muted)" }}
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative overflow-hidden">
                ...
                >
                  ...
                  {status === "error" && (
                    <div className="absolute left-0 top-0 h-full w-full bg-red-500/10" />
                  )}
                  <span className="relative flex items-center gap-2">
                    {status === "idle" && (
                      <>
                        <Send width={12} height={12} /> Send Message
                      </>
                    )}
                    {status === "loading" && (
                    ...
                    {status === "error" && (
                      <>
                        <XCircle className="w-3 h-3 text-red-400" /> Failed, try
                        again
                      </>
                    )}
                  </span>
