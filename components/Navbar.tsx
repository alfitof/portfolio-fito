  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6 h-12 flex items-center justify-between">
        ...
        {/* Desktop */}
        <div className="hidden md:flex items-center gap-6 text-xs" style={{ color: "var(--text-secondary)" }}>
          {links.map((link) => (
            <Link
              key={link.href}
              href={link.href}
        ...
        >
          {links.map((link) => (
            <Link
              ...
              style={{ color: active === link.label ? "var(--text-primary)" : "var(--text-secondary)" }}
            >
              {link.label}
            </Link>
          ))}
